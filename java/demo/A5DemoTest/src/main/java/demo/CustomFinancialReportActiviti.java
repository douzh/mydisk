 ...
 * 
 * 
 * activiti提供的财务报告审核 <!-- 采用用户组为accountancy编写财务报告 --> <userTask id="usertask1"
 * name="财务编写月财务报告" activiti:candidateGroups="accountancy"></userTask> <!--
 * 采用用户组为management编写财务报告 --> <userTask id="usertask2" name="股东审核月财务审计报告"
...
public class CustomFinancialReportActiviti {
	...
	private static void init() {
		...
		repositoryService.createDeployment()
				.addClasspathResource("diagrams/Account.bpmn").deploy();
		// Get the first task
